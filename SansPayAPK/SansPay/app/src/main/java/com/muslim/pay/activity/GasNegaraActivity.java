...
public class GasNegaraActivity extends AppCompatActivity {
    WebView webView;
    ProgressBar bar;
    TextView loading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gas_negara);
        getSupportActionBar().hide();

        bar= (ProgressBar) findViewById(R.id.pb_gasnegara);
        loading = findViewById(R.id.loading);
        lyoutbonus = findViewById(R.id.ll_gasnegara);
        back = findViewById(R.id.bb_gasnegara);
        BaseUrl = Constant.SERVER_BAYAR;

        webView = (WebView) findViewById(R.id.wb_gasnegara);
        ...
        if (networkInfo == null || !networkInfo.isConnected() || !networkInfo.isAvailable()) {
            ...
            webView.loadUrl(BaseUrl+ "pembayaran-gas-negara");
        }
