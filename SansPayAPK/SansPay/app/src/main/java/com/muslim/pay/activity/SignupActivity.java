...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView) findViewById(R.id.wb_signup);
        bar=(ProgressBar) findViewById(R.id.pb_signup);
        layoutloading = findViewById(R.id.ll_signup);
        ...
        if (networkInfo == null || !networkInfo.isConnected() || !networkInfo.isAvailable()) {
            ...
            webView.loadUrl("https://obsterindonesia.cf/register");
        }
    ...
    private class myWebclient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.equals("https://obsterindonesia.cf/member")) {
